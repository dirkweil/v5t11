...
public class TestLokData {
  ...
  public static final Lok lok103_003_0 = new Lok("103 003-0", null, SystemTyp.DCC, false, 1103, 126,
      ...
      2, new Lok.FunktionConfig("Betriebsgeräusch", false),
      3, new Lok.FunktionConfig("Pfeife", true, true),
      ...
      10, new Lok.FunktionConfig("Bahnhofsansage \"Bitte einsteigen ...\"", true),
      11, new Lok.FunktionConfig("Lüfter", false),
      12, new Lok.FunktionConfig("Sanden", true),
      13, new Lok.FunktionConfig("Bahnhofsansage \"... an Gleis 1 fährt ein Zug durch ...\"", true),
      14, new Lok.FunktionConfig("Bahnhofsansage \"Betriebsgefahr ...\"", true),
  ...
  public static final Lok lok217_001_7 = new Lok("217 001-7", null, SystemTyp.SX2, false, 1217, 127,
      ...
      3, new Lok.FunktionConfig("Signalhorn hoch", true, true),
      4, new Lok.FunktionConfig("ABV aus", false),
      5, new Lok.FunktionConfig("Bremsenquietschen aus", false),
      6, new Lok.FunktionConfig("Spitzensignal 2 aus", false),
      7, new Lok.FunktionConfig("Signalhorn hoch", true),
      8, new Lok.FunktionConfig("Spitzensignal 1 aus", false),
      9, new Lok.FunktionConfig("Hilfsdieselgeräusch", true),
      10, new Lok.FunktionConfig("Kompressorgeräusch", true),
      11, new Lok.FunktionConfig("Schaffnerpfiff", true),
      12, new Lok.FunktionConfig("Bahnhofsansage \"... an Gleis 1 fährt ein Zug durch ...\"", true),
      13, new Lok.FunktionConfig("Sanden", true),
      14, new Lok.FunktionConfig("Bahnhofsansage \"Bitte einsteigen ...\"", true),
      15, new Lok.FunktionConfig("Geräusche ein/ausblenden", true));
  ...
  public static final Lok lokV100_1365 = new Lok("V100 1365", null, SystemTyp.SX2, false, 1365, 127,
      1, new Lok.FunktionConfig("Spitzensignal nur vorn", false),
      2, new Lok.FunktionConfig("Motorgeräusch", false),
      3, new Lok.FunktionConfig("Signalhorn hoch", true),
      4, new Lok.FunktionConfig("ABV aus", false),
      5, new Lok.FunktionConfig("Bremsenquietschen aus", false),
      6, new Lok.FunktionConfig("Spitzensignal 2 aus", false),
      7, new Lok.FunktionConfig("Führerstandsbeleuchtung", false),
      8, new Lok.FunktionConfig("Spitzensignal 1 aus", false),
      9, new Lok.FunktionConfig("Glocke", true),
      10, new Lok.FunktionConfig("Signalhorn tief", true),
      11, new Lok.FunktionConfig("Kompressor", false),
      12, new Lok.FunktionConfig("Ansage", true),
      13, new Lok.FunktionConfig("Schaffnerpfiff", true),
      14, new Lok.FunktionConfig("Türenschließen", true));
