...
public class LauncherFactory {
  ...
  /*
   * This is a quick-and-dirty hack for redirecting the log output of JUnit5 and tests run by it
   * into JBoss Logging or Log4j2, if any of those is on the classpath.
   * 
   * It would be better to have some JUnit 5 extension for initializing JUnit 5 before any JUL part is used.
   */
  static {

    System.setProperty("java.util.logging.manager", "org.jboss.logmanager.LogManager");
    // for (String className : new String[] { "org.jboss.logmanager.LogManager", "org.apache.logging.log4j.jul.LogManager" }) {
    // try {
   ...
   *
   * @param config
   *          the configuration for the launcher; never {@code null}
   * @throws PreconditionViolationException
