...
public class OldFahrstrasse extends Bereichselement {
   ...
   */
  public static OldFahrstrasse concat(OldFahrstrasse linkeFahrstrasse, OldFahrstrasse rechteFahrstrasse) {
    ...
    OldFahrstrasse result = new OldFahrstrasse();
  ...
  public boolean isFrei(boolean includeStart, boolean includeEnde) {
    synchronized (OldFahrstrasse.class) {
  ...
  public boolean reservieren(FahrstrassenReservierungsTyp reservierungsTyp, boolean includeStart, boolean includeEnde) {
    ...
    synchronized (OldFahrstrasse.class) {
      ...
      this.elemente.forEach(fe -> fe.oldReservieren(this));
    }
   ...
   */
  public OldFahrstrasse createUmkehrung() {
    OldFahrstrasse fahrstrasse = new OldFahrstrasse();
