...
public abstract class GbsElement extends JPanel
{
   ...
   * 
   * @param g2d Grafik-Kontext
   * @param color Farbe
   * @param gbsRichtung Richtung
   */
   ...
   * @param color Farbe
   * @param gbsRichtung Richtung
   * @param spitze <code>true</code>, wenn dieses Segment in Fahrtrichtung weist
   */
   ...
   * @param stellwerkElement Stellwerkelement
   * @return GbsElement
   */
